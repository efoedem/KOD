...
# Ensure Cloudinary SDK is initialized
cloudinary.config(
    cloud_name=os.environ.get('CLOUDINARY_CLOUD_NAME'),
    api_key=os.environ.get('CLOUDINARY_API_KEY'),
    api_secret=os.environ.get('CLOUDINARY_API_SECRET'),
...
# Force Postgres if on production, otherwise default to sqlite
...
# --- SvdPay Configuration ---
SDVPAY_SECRET_KEY = os.getenv('SDVPAY_SECRET_KEY')

# --- Email Configuration ---
# Set to 'django.core.mail.backends.console.EmailBackend' to test in terminal
# settings.py
